export function loadObitCameraPlugin() {
  ...
  OrbitCamera.prototype.focus = function (focusEntity) {
    ...
    this.distance =
      (radius * 1.5) /
      Math.sin(0.5 * this.entity.camera.fov * pc.math.DEG_TO_RAD);
  ...
  OrbitCamera.prototype._calcPitch = function (quat, yaw) {
    ...
    return (
      Math.atan2(transformedForward.y, -transformedForward.z) * pc.math.RAD_TO_DEG
    );
  };
  ...
  OrbitCameraInputTouch.prototype.calcMidPoint = function (
    pointA,
    pointB,
    result
  ) {
